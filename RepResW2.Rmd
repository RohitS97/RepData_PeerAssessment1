...
```{r , echo=TRUE}
knitr::opts_chunk$set(echo = TRUE,options(repos = list(CRAN="http://cran.rstudio.com/")))
```
...
- I have made the histogram of original as well as the log10 of the variables as it's distribution seemed skewed towards right
...
- Imputing missing values by median seemed apt because there were a lot of values at 0 and the missing population was high too
```{r}
sum(is.na(df1$steps))
